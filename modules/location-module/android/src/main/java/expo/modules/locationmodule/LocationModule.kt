...
import expo.modules.locationmodule.records.GeocodeResponse
import expo.modules.locationmodule.records.GeofencingOptions
import expo.modules.locationmodule.records.Heading
import expo.modules.locationmodule.records.HeadingEventResponse
import expo.modules.locationmodule.records.LocationLastKnownOptions
import expo.modules.locationmodule.records.LocationOptions
import expo.modules.locationmodule.records.LocationProviderStatus
import expo.modules.locationmodule.records.LocationResponse
import expo.modules.locationmodule.records.LocationTaskOptions
import expo.modules.locationmodule.records.PermissionDetailsLocationAndroid
import expo.modules.locationmodule.records.PermissionRequestResponse
import expo.modules.locationmodule.records.ReverseGeocodeLocation
import expo.modules.locationmodule.records.ReverseGeocodeResponse
import expo.modules.locationmodule.taskConsumers.GeofencingTaskConsumer
import expo.modules.locationmodule.taskConsumers.LocationTaskConsumer
...
class LocationModule : Module(), LifecycleEventListener, SensorEventListener, ActivityEventListener {
  ...
  override fun definition() = ModuleDefinition {
    ...
    AsyncFunction("getCustomPermissionLocation") Coroutine { ->
      val permissionsManager = appContext.permissions ?: throw NoPermissionsModuleException()
